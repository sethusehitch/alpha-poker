...
"""Summit v28: public range equity and correlated-evidence tempering.
...
def lookahead(s, particles, holes, rng, fallback):
    ...
    for _ in range(20):
        ...
        for ai,action in enumerate(actions):
            ...
            for step in range(32):
                ...
                eq=public_equity([INDEX[c] for c in st['hole_cards']],[INDEX[c] for c in st['community_cards']],local,8)
    ...
    return actions[best] if values[best]>values[fallback_index]+.08*s['pot']*20 else fallback
