...
import { emit } from "../components/uiBus";
...
export default function AuthorizeCli() {
  ...
  return <main className="mx-auto max-w-lg px-4 py-16"><section className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
